...
redox<-readr::read_csv("https://docs.google.com/spreadsheets/d/e/2PACX-1vQyEg6KzIt6SdtSKLKbbL3AtPbVffq-Du-3RY9Xq0T9TwPRFcgvKAYKQx89CKWhpTKczPG9hKVGUfTw/pub?gid=1911552509&single=true&output=csv") |>
  dplyr::filter(Year==2024,TransectPoint_ID<=1150) %>%
...
# pca is fine for abiotic components, do not use it for species composition! 
...
# and label the axis with the explained variation which is in this case PC1 49% and PC2 21%
...
# for vegan stuff you need the table to be wide and not long format
...
nmds_veg
vegan::ordiplot(nmds_veg,type="t") # shows which plots have the same species composition, might be the case that they can form a community together
...
# --> 8 species goes through their optimum. So should DCA or NMDS
